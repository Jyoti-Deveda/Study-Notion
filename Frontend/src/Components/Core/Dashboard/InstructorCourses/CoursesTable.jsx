      ...
      <Table className="rounded-xl border border-richblack-800">
        <Thead>
          <Tr className="flex gap-x-10 rounded-t-md border-b border-b-richblack-800 px-6 py-2">
            ...
            <Th className="text-left text-sm font-medium uppercase text-richblack-100 custom-md:hidden">
              Duration
            </Th>
        ...
        <Tbody className=''>
          {courses?.length === 0 ? (
            ...
            courses?.map((course) => (
              ...
              >
                <Td className="flex custom-md:flex-col flex-1 gap-x-4 gap-y-2">
                  <img
                ...
                <Td className="text-sm font-medium text-richblack-100 custom-md:hidden">
                  2hr 30min
                </Td>
