...
export const MyProfile = () => {
  ...
  return (
    <div className='flex flex-col  custom-lg:w-[70%] w-[100%] gap-y-5'>
        <h1 className='text-2xl text-richblack-5 font-bold m-2'>
            My Profile
        </h1>

        {/* section 1 */}
        <div className='flex custom-lg:flex-row flex-col-reverse justify-between custom-lg:items-center items-start bg-richblack-800 px-5 py-4 rounded-md
        ...
        {/* section 2  */}
        <div className='flex flex-col  bg-richblack-800 px-5 py-4 rounded-md
